...
class Shape {
    ...
    func simpleDescription() -> String {
        return "A shape with \(numberOfSides) sides and the owner of the shape is \(owner)."
    }
    func shapeSizeDescription() -> String {
        return "The size of this shape is still \(size)"
    }
    func colorDescription(color: String) -> String {
        return "The color of this shape is currently \(color)"
    }
}
...
var shapeColorDescription = shape.colorDescription(color: "Blue")
...
let test2 = Circle(radius: 2, name: "Jaro")
test2.area()
